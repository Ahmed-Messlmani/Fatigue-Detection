...
# load our serialized face detector model from disk
	...
	prototxtPath = "C:/Users/ahmed/OneDrive/Bureau/fatiguedetection/face_detector/deploy.prototxt"
	weightsPath ="C:/Users/ahmed/OneDrive/Bureau/fatiguedetection/face_detector/res10_300x300_ssd_iter_140000.caffemodel"
	faceNet = cv2.dnn.readNet(prototxtPath, weightsPath)

	# load the face mask detector model from disk
	print("[INFO] loading face mask detector model...")
	#maskNet = load_model(args["model"])
	maskNet =tf.keras.models.load_model('C:/Users/ahmed/OneDrive/Bureau/fatiguedetection/models/modeltranslearning.h5')
...
def predictindex():
	...
	if request.method == 'POST':
		...
		new_model = tf.keras.models.load_model('C:/Users/ahmed/OneDrive/Bureau/fatiguedetection/models/modeltransfertlearning')
